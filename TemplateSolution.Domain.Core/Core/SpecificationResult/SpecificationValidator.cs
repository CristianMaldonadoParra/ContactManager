...
using TemplateSolution.Domain.Core.Core.SpecificationResult.Result;
using TemplateSolution.Domain.Core.Core.SpecificationResult.Validation;
using System;
using System.Linq.Expressions;

namespace TemplateSolution.Domain.Core.Core.SpecificationResult
{
